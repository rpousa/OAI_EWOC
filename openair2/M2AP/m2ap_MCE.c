...
int m2ap_MCE_init_sctp (m2ap_MCE_instance_t *instance_p,
  ...
  MessageDef *message = itti_alloc_new_message_sized(TASK_M2AP_MCE, 0, SCTP_INIT_MSG_MULTI_REQ, sizeof(sctp_init_t) + addr_len);
